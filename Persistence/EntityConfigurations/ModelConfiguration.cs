...
namespace Persistence.EntityConfigurations
{
    public class ModelConfiguration : IEntityTypeConfiguration<Model>
    {
        ...
        {
            builder.ToTable("Models").HasKey(b => b.Id); //veritabanında brands e kaşrıık gelicek
            ...
            builder.HasOne(b => b.Brand); //bir modelin bir tane markası olur
            builder.HasOne(b => b.Fuel); 
            builder.HasOne(b => b.Transmission); 
            builder.HasMany(b => b.Cars); 

            builder.HasQueryFilter(b => !b.DeletedDate.HasValue); //global query
        }
    }
}
