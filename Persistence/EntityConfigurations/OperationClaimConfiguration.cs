...
public class OperationClaimConfiguration : IEntityTypeConfiguration<OperationClaim>
{
    ...
    //                && type.IsClass && type.Name.EndsWith("OperationClaims")
    //                );
    ...
    //            IEnumerable<OperationClaim> featureOperationClaimsToAdd = typeFieldsValues.Select(value => new OperationClaim { Id = ++id, Name = value });
